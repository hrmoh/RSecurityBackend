...
namespace RSecurityBackend.Controllers
{
    ...
    public abstract class WorkspaceRoleControllerBase : Controller
    {
        ...
        public async Task<IActionResult> Get()
        {
            ...
            RServiceResult<RWSRole[]> rolesInfo = await _roleService.GetAllRoles();
        ...
        {
            RServiceResult<RWSRole> roleInfo = await _roleService.GetRoleInformation(roleName);
        ...
        public async Task<IActionResult> Post([FromBody] RWSRole newGroupInfo)
        {
        ...
        [ProducesResponseType((int)HttpStatusCode.BadRequest, Type = typeof(string))]
        [ProducesResponseType((int)HttpStatusCode.Forbidden)]
        public async Task<IActionResult> Put(string roleName, [FromBody] RWSRole existingGroupInfo)
        {
